...
HD_PWD='C:/Users/RISHIK NAIR/Downloads/Projects/tsp groq/Vivado/HAC/HAC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hac_deskew_dut.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hac_deskew_dut.tcl
