...
HD_PWD='C:/Users/RISHIK NAIR/Downloads/Projects/tsp groq/Vivado/HAC/HAC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hac_deskew_dut.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hac_deskew_dut.tcl -notrace
